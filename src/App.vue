<template>
  <div id="app">
    ...
    <button v-on:click="addFavourite" :value="favourite-country">Add Country to favourites</button>

    <favourite-countries :favourite-country="selectedCountry"></favourite-countries>
</div>
